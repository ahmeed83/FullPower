            ...
            <div className="bg-white px-10 py-20">
                <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <h3 className="mt-4 text-lg leading-6 font-medium text-gray-900" id="modal-title">
                            Please insert the customer that you want to authorize this account for:
                        </h3>
                        <div className="mt-4">
                            <input
                        ...
                        <div className="mt-4">
                            <DropDown setAuthorizationType={setAuthorizationType}/>
                        </div>
                    </div>
                </div>
            </div>
