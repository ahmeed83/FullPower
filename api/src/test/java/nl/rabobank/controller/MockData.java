...
public class MockData {
     ...
     * Customer 2 own one account CUSTOMER_GRANTEE_PAYMENT_ACCOUNT and has permission to customer 1 account 
     * CUSTOMER_GRANTOR_PAYMENT_ACCOUNT
     */
    ...
    private static CustomerAccountDetails getCustomerDetails(
            final CustomerAccountDetails.CustomerAccountDetailsBuilder account,
